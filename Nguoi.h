...
class Nguoi
{
    ...
    public:
        ...
        //Nguoi();
        Nguoi(int id = 0, string ten = "None", string sdt = "None", string gioi_tinh = "None", string ngay_sinh = "None", string dia_chi = "None");
...
Nguoi::Nguoi(int id, string ten, string sdt, string gioi_tinh, string ngay_sinh, string dia_chi)
    :id(id), ten(ten), sdt(sdt), gioi_tinh(gioi_tinh), ngay_sinh(ngay_sinh), dia_chi(dia_chi)
{
...
void Nguoi::nhap(int i)
{
    ...
    cout << "Nhap ngay sinh: "; getline(cin, this->ngay_sinh);
