...
void do_selection_1_1(HoaDon &hoa_don_moi, vector<HangHoa> &danh_sach_hang_hoa) {
	...
	cout << left << setw(10) << "So luong trong kho" << endl;
    ...
    for (int i = 0; i < danh_sach_hang_hoa.size(); i++) {
        if (danh_sach_hang_hoa[i].get_ma_hh() == ma_hh) {
            if (danh_sach_hang_hoa[i].get_so_luong() >= stoi(so_luong)) {
                ...
                cout << "So luong hang trong kho khong du\n" << endl;
                break;
            }
        }
    }
...
void do_selection_5_4() {
    cout << "\nDoanh thu: " << doanh_thu * 1000 << " VND" << endl;
    data_doanh_thu.close();
    data_doanh_thu.open("doanh_thu.txt", ios::out);
    data_doanh_thu << doanh_thu << endl;
    data_doanh_thu.close();
    ...
    cout << "\nLoi nhuan: " << (doanh_thu - chi_phi) * 1000 << " VND" << endl;
    data_loi_nhuan.close();
    data_loi_nhuan.open("loi_nhuan.txt", ios::out);
...
int main()
{
    ...
    int lua_chon = -1;
    do {
        cout << "\n*****Chuong trinh quan ly kinh doanh*****" << endl;
        cout << "0. Thoat chuong trinh" << endl;
        cout << "1. Ban hang (in hoa don cho khach hang)" << endl;
        cout << "2. Nhap hang (in phieu nhap hang tu nha cung cap)" << endl;
