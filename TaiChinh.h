...
class TaiChinh
{
	private:
		...
		double loi_nhuan;
	public:
		TaiChinh(double doanh_thu, double chi_phi, double loi_nhuan);
		~TaiChinh();
		void nhap(int i);
	 	void xuat(int i);
 ...
 TaiChinh::TaiChinh(double doanh_thu, double chi_phi, double loi_nhuan)
 {
 	doanh_thu =0;
	chi_phi=0;
	loi_nhuan=0; 
